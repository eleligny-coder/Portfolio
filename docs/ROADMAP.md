...
## Phase 0 — Sécurité et cohérence du repository
...
- [x] Captures réelles intégrées aux projets.
...
## Phase 2 — Finition premium

- Rationaliser les couches CSS historiques.
- Fusionner les contrôleurs d’effets globaux.
- Réduire les traitements pointer / scroll non essentiels.
- Renforcer accessibilité clavier et lightbox.
- Enrichir chaque étude de cas avec davantage de preuves visuelles qualifiées.
