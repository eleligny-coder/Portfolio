...
export default function Page() {
  return <>
    ...
    <section className="section"><div className="shell grid two">
      ...
      <article className="card"><span className="eyebrow">Entreprise</span><h2>Livré d’un Clic SASU</h2><p>Société éditrice de logiciels et studio de conception de produits numériques : SaaS, applications métiers, IA, automatisation, conseil et projets à impact.</p><div className="actions"><Link className="btn secondary" href="/entreprise">Voir la structure derrière les produits</Link></div></article>
