    ...
    <section className="premium-hero-wrap">
      ...
      <section className="hero shell premium-hero">
        <div className="hero-copy">
          ...
          <div className="proofs premium-proofs"><div><strong>5+</strong><span>années de pratique</span></div><div><strong>4</strong><span>produits SaaS majeurs</span></div><div><strong>5</strong><span>études de cas présentées</span></div><div><strong>100 %</strong><span>télétravail</span></div></div>
        </div>
