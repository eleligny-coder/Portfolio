...
export default function Page() {
  return <>
    ...
    <section className="section"><div className="shell grid two">{trainings.map(t => <article className="card" key={t}><span className="eyebrow">Programme</span><h2>{t}</h2><p>Objectifs, cas pratiques, exercices, supports, évaluation et plan d’action personnalisé.</p></article>)}</div></section>
