...
export const projects: Project[] = [
  ...
  },
  {
    ...
    eyebrow: "Prototype historique",
    summary: "Première version de la marketplace, utilisée pour valider les parcours métier avant l’abandon de WordPress et la reconstruction sur la nouvelle stack France Reliance.",
    status: "Version WordPress abandonnée — projet historique",
    accent: "violet",
    ...
    roadmap: ["Version clôturée", "Architecture remplacée par France Reliance"],
    image: "/projects/livre-d-un-clic-wordpress-about.webp",
